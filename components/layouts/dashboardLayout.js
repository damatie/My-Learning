    ...
    return (
        <>
            ...
            <section className='bg-accent h-screen w-screen'>
                ...
                <main className={`${reduceAppSideNav ? 'overflow-y-auto h-full fixed right-0 md:w-10/12 bg-green-800 transition-all' : 'md:w-11/12 bg-green-800 transition-all fixed  h-full overflow-y-auto right-0'}`}>
