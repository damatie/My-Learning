            ...
            <div className=''>
                ...
                <ul className='w-full flex flex-col '>
                    <li className={`${!reduceAppSideNav ? 'mb-2 w-10/12 grid place-items-center mx-auto' : 'mb-2 w-full grid place-items-center mx-auto'}`}>
                        <Link   href='/'>
                            <a className={`${ !reduceAppSideNav ? 'inline-flex px-1 py-1 transition-all  rounded-md font-semibold items-center text-center w-1/2 justify-center text-base  bg-accent active:bg-accent  focus:bg-accent hover:bg-accent active:text-primary' : ' transition-all  inline-flex px-1 py-1 rounded-md font-semibold items-center text-center w-full bg-accent justify-center text-base active:bg-accent  focus:bg-accent hover:bg-accent active:text-primary' }`}>
