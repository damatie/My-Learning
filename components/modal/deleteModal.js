...
function DeleteModal({openDeleteModal,setOpenDeleteModal,deleteHighlightEmployee,highlightId,editSingleEmployee}) {
    ...
    return (
        <div className='absolute delete-bg h-full overflow-y-auto w-full left-0 top-0 bg-black bg-opacity-25 z-20' onClick={(e)=>clickedCancelBgDeleteModal(e,openDeleteModal)}>
            <div className='bg-white rounded-lg p-4 py-10 top-1/4 right-1/4  pb-7 w-4/12 xl:w-5/12 flex items-center flex-col absolute'>
                <h3 className='w-7/12 text-center mb-5 text-xbase'>Do you really want to delete the Employee: <span className='text-success font-semibold uppercase'>adams bedford</span> from your employee list </h3>
